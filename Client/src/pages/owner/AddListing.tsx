...
export default function AddListing() {
    ...
    const extractCoordinatesFromGoogleMaps = (
        ...
        try {
            ...
            if (url.includes("goo.gl") || url.includes("maps.google.com")) {
                console.warn("Could not extract coordinates precisely, defaulting to fallback.");
                // استخدام إحداثيات افتراضية (الإسكندرية كمثال)
                return [30.0000, 31.0000]; 
            }
    ...
    const onSubmit = async (data: AddListingFormData) => {
        ...
        try {
            ...
            let coordinates: [number, number] = [30.0000, 31.0000]; // افتراضي
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="mb-8 rtl:text-right">
                        ...
                        <p className="text-muted-foreground dark:text-gray-400">
                            {user?.role === "admin" ? t("dashboard.subtitle.admin") : t("owner.addListingSubtitle")}
                        </p>
                    </div>

                    <Card className="max-w-4xl mx-auto dark:bg-gray-800 dark:border-gray-700" dir={isArabic ? "rtl" : "ltr"}>
                        <CardHeader>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="name" className="rtl:text-right block dark:text-gray-300">
                                        ...
                                        <Input
                                            ...
                                            {...register("name", { required: t("owner.validation.requiredName") })}
                                        />
                                        {errors.name && (
                                    ...
                                    {/* City */}
                                    <div className="space-y-2">
                                        <Label htmlFor="city" className="rtl:text-right block dark:text-gray-300">
                                            {t("owner.form.label.city")}
                                        </Label>
                                        <Input
                                            id="city"
                                            className="rtl:text-right dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                            {...register("city", { required: t("owner.validation.requiredCity") })}
                                        />
                                        {errors.city && (
                                            <p className="text-sm text-destructive rtl:text-right">
                                                {errors.city.message}
                                ...
                                {/* Address */}
                                <div className="space-y-2">
                                    <Label htmlFor="address" className="rtl:text-right block dark:text-gray-300">
                                    ...
                                    <Textarea
                                        ...
                                        className="rtl:text-right dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        {...register("address", { required: t("owner.validation.requiredAddress") })}
                                    />
                                    {errors.address && (
                                        <p className="text-sm text-destructive rtl:text-right">
                                ...
                                {/* Google Maps Link */}
                                <div className="space-y-2">
                                    <Label htmlFor="googleMapsLink" className="rtl:text-right block dark:text-gray-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {/* Category */}
                                    <div className="space-y-2">
                                        <Label htmlFor="category" className="rtl:text-right block dark:text-gray-300">
                                        ...
                                        <Input
                                            ...
                                            className="rtl:text-right dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                            {...register("category", { required: t("owner.validation.requiredCategory") })}
                                        />
                                        {errors.category && (
                                            <p className="text-sm text-destructive rtl:text-right">
                                    ...
                                    {/* Price Level */}
                                    <div className="space-y-2">
                                        <Label htmlFor="priceLevel" className="rtl:text-right block dark:text-gray-300">
                                    ...
                                    {/* Phone (Optional) */}
                                    <div className="space-y-2">
                                        <Label htmlFor="phone" className="rtl:text-right block dark:text-gray-300">
                                ...
                                {/* Website (Optional) */}
                                <div className="space-y-2">
                                    <Label htmlFor="website" className="rtl:text-right block dark:text-gray-300">
                                ...
                                <div className={`flex gap-4 pt-4 ${isArabic ? "justify-start" : "justify-end"}`}>
                                    <Button
                                        type="button"
                                        variant="outline"
                                    ...
                                    <Button type="submit" disabled={isLoading} className="bg-[#ef4343] hover:bg-[#ff7e7e]">
                                        {isLoading ? (
                                            <Loader2 className={`mr-2 h-4 w-4 animate-spin ${isArabic ? "ml-2" : "mr-2"}`} />
                                        ) : (
                                            <>
                                                {user?.role === "admin"
