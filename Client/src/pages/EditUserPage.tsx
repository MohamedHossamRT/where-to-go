        ...
        <div className="flex min-h-screen flex-col">
            ...
            <div className="flex-1 bg-muted/30 dark:bg-gray-900 py-10">
                <div className="container mx-auto px-4">
                    ...
                    <Card className="max-w-2xl mx-auto dark:bg-gray-800 dark:border-gray-700" dir={isArabic ? "rtl" : "ltr"}>
                        <CardHeader>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {/* EMAIL Field */}
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="rtl:text-right block dark:text-gray-300">
                                ...
                                {/* PASSWORD Field */}
                                <div className="space-y-2">
                                    <Label htmlFor="password" className="rtl:text-right block dark:text-gray-300">
                                ...
                                {/* ROLE Field */}
                                <div className="space-y-2">
                                    <Label htmlFor="role" className="rtl:text-right block dark:text-gray-300">
                                        {t("addUser.form.role")}
                                    </Label>
                                    <Select 
